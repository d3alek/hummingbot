...
from hummingbot.connector.derivative.huobi_perpetual.huobi_perpetual_api_order_book_data_source import HuobiPerpetualAPIOrderBookDataSource
...
class HuobiPerpetualOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(
            data_source=HuobiPerpetualAPIOrderBookDataSource(
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            self._data_source = HuobiPerpetualAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
