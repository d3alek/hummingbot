...
from hummingbot.connector.derivative.huobi_perpetual.huobi_perpetual_utils import convert_from_exchange_trading_pair
...
cdef class HuobiPerpetualOrderBook(OrderBook):
    @classmethod
    ...
    def from_snapshot(cls, msg: OrderBookMessage) -> "OrderBook":
        retval = HuobiPerpetualOrderBook()
