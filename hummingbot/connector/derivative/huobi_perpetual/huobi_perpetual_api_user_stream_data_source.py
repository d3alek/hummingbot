...
from hummingbot.connector.derivative.huobi_perpetual.huobi_perpetual_utils import build_api_factory
...
class HuobiPerpetualAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, huobi_auth: HuobiPerpetualAuth, api_factory: Optional[WebAssistantsFactory] = None):
        self._auth: HuobiPerpetualAuth = huobi_auth
